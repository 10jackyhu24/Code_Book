...
```
pandoc code_book.md -o codebook.pdf --pdf-engine=xelatex -V geometry:"top=1cm, bottom=1.5cm, left=1cm, right=1cm, footskip=0.6cm" -V classoption=twocolumn -V fontsize=9pt --include-in-header=header.tex
```